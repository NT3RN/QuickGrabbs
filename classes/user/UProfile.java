	...
	public UProfile(String user)
	{
		...
		String line4=" ";
            try {
                ...
                {
                    line1 = Files.readAllLines(Paths.get("data\\user_data\\user_data.txt")).get(i);
                    
                    if (line1.equals(userNameS)) 
                    {
                        line2 = Files.readAllLines(Paths.get("data\\user_data\\user_data.txt")).get((i + 1));
                        line3 = Files.readAllLines(Paths.get("data\\user_data\\user_data.txt")).get((i + 2));
                        line4 = Files.readAllLines(Paths.get("data\\user_data\\user_data.txt")).get((i + 3));
                            break;
                        }
                    }
